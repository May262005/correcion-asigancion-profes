      ...
      <div class="page-header">
        <div class="header-title-flex">
          ...
          <div class="header-text">
            ...
            <p>Selecciona los bloques de tiempo en los que estás disponible para impartir clases o asesorías.</p>
          </div>
      ...
      <div v-else-if="profesorSeleccionado && horasMostradas.length" class="horario-card">
        <div class="card-header-flex">
          <div class="instr">
            ...
            <span>Haz clic en los cuadros para marcar/desmarcar tu disponibilidad.</span>
          </div>
          <div class="actions">
...
// Obtener el ID del profesor desde localStorage (id_rol)
const profesorSeleccionado = ref(localStorage.getItem('id_rol'))
...
const cargarDatosProfesor = async () => {
  const id = profesorSeleccionado.value
  if (!id) {
    console.error('No se encontró id_rol del profesor en localStorage')
    return
  }
  ...
  try {
    // Cargar datos del profesor para obtener el nombre
...
const guardarCambios = async () => {
  ...
  try {
    ...
    await Swal.fire({
      icon: 'success',
      title: '¡Guardado!',
      text: 'Tu disponibilidad ha sido actualizada correctamente',
